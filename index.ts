...
// let personal_message:string=("Hello Eric, would you like to learn some python today?")
...
// let personal_name:string="Faraz Azeem";
...
// let favorite_number:number=87689;
...
// let array:string[]=["faraz","Faran","Aness","Farrukh","shamoon"]
...
// for (let i=0; i<array.length; i++)
// {
//     console.log(`hello ${array[i]} i hope you are doing well`);
// }
...
// let favoriteTransportation:string[]=["suzuki motorcycle","Honda car"]
...
// let guestList:string[]=["faraz","faran","farrukh"]
// guestList.forEach((invitaion)=>{
//   console.log(`Mr. ${invitation} i would like to invite you to attend the dinner which for the old friend `)
// })
...
// let GuestList:string[]=["faraz","faran","farrukh","Aness"]
...
// GuestList.unshift("Azam");
// GuestList.splice(GuestList.length/2,0,"kashif")
...
// let favoriteLocation:string[]=["America","United Kingdom","pakistan","Canada","Isreal"]
...
// let DinnerGuestList:string[]=["faraz","faran","farrukh","Anees"]
...
// let country:string[]=["pakistan","india","America","United Kingdom","Isreal"]
...
// let identification=[{Name:"faraz",city:"sahiwal",Province:"punjab",phone:"098765453"},
// {Name:"faran",city:"sahiwal",Province:"punjab",phone:"098765453"},
// {Name:"farrukh",city:"sahiwal",Province:"punjab",phone:"098765453"}
// ]
...
// let intentionError:string[]=["faraz","faran","farrukh","Aness","Azam","kashif"]
...
// let fruits:string[]=["banana","apple","mango","dates","watermelon"]
...
// let helloAdmin:string[]=["admin","IT officer","coordinator","OFA","Accountant"]
...
// let current_user:string[]=["faraz","faran","farrukh","Azeem","Anees"]
// let new_user:string[]=["faraz","Kashif","Saqib","Azeem","faran"]
...
// function shirt(size:string="large", message:string="I love typecript")
// {
...
// function magician(magician_show:string[]=["faraz","faran","farrukh","Azeem"]) {
